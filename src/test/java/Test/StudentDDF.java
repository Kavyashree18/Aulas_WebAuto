...
public class StudentDDF extends BaseTest 
{
		...
		public void createnewlogin(String Name,String Email,String Phone,String HouseNO,String City,String State,String Zip) throws InterruptedException
		//public void createnewLogin(String email,String password)
		{
		Thread.sleep(4000);
		driver.findElement(By.xpath("//div[@class='m-t-5']/input")).sendKeys("fahd.hazarika@vectorseducation.com");
		//driver.findElement(By.xpath("//div[@class='m-t-5']/input")).sendKeys(email);
		driver.findElement(By.xpath("//div[@class='m-t-20']/span/input")).sendKeys("1234");
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("(//div[@class='rc-virtual-list']/div/div)[1]/div/div[4]")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[contains(@class,'rc-virtual')])[6]/div/div/div/div[2]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[@class='ant-select-selector'])[4]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[contains(@class,'rc-virtual')])[12]/div/div/div[8]")).click();
		Thread.sleep(4000);
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("(//div[@class='r-c-sb']/input)[9]")).sendKeys(HouseNO);
		Thread.sleep(4000);
		driver.findElement(By.xpath("(//div[@class='r-c-sb']/input)[10]")).sendKeys(City);
		Thread.sleep(4000);
		driver.findElement(By.xpath("(//div[@class='r-c-sb']/input)[11]")).sendKeys(State);
		Thread.sleep(4000);
		driver.findElement(By.xpath("(//input[@class='ant-input'])[12]")).sendKeys(Zip);
		Thread.sleep(4000);
