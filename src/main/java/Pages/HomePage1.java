...
public class HomePage1 extends BaseTest
{
	...
	@FindBy(xpath="(//li[contains(@class,'ant-menu-item')])[3]")
	WebElement Schedule;
	...
	WebElement Test;
	@FindBy(xpath="(//li[contains(@class,'ant-menu-item')])[10]")
	...
	WebElement Close;
	@FindBy(xpath="//span[@class='anticon anticon-right']")
...
//		return null;
	...
	public FeeMgmtPage FeeManagement() 
	{
		FeeManagement.click();
...
//		return Announcements();
	...
	public NewDigitalLibrary DigitalLibrary()
	{
	...
	public TestPages Test()
	{

		Test.click();
		return null;
	
//		return new TestPages();
	}
